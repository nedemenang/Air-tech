...
@card_blueprint.route('/', strict_slashes=False, methods=['GET'])
def list_card_details():
    return card_controller.list_card_details()


@card_blueprint.route('/<int:card_id>/', strict_slashes=False, methods=['GET'])
def get_card_details(card_id):
    return card_controller.get_card_details(card_id)


@card_blueprint.route('/', strict_slashes=False, methods=['POST'])
...
@card_blueprint.route('/<int:card_id>/', strict_slashes=False, methods=['PATCH', 'PUT'])
...
@card_blueprint.route('/<int:card_id>/', strict_slashes=False, methods=['DELETE'])
