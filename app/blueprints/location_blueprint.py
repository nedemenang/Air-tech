...
@location_blueprint.route('/', strict_slashes=False, methods=['GET'])
def list_locations():
    return location_controller.get_locations()


@location_blueprint.route('/<int:location_id>/', strict_slashes=False, methods=['GET'])
def get_location(location_id):
    return location_controller.get_location(location_id)


@location_blueprint.route('/', strict_slashes=False, methods=['POST'])
...
@location_blueprint.route('/<int:location_id>/', strict_slashes=False, methods=['PUT'])
@Security.validator(['locationCode|required:string', 'location|required:string'])
...
@location_blueprint.route('/<int:location_id>/', strict_slashes=False, methods=['DELETE'])
