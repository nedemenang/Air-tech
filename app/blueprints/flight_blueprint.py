...
@flight_blueprint.route('/', strict_slashes=False, methods=['GET'])
def list_flight():
    return flight_controller.get_flights()


@flight_blueprint.route('/<int:flight_id>/', strict_slashes=False, methods=['GET'])
def get_flight(flight_id):
    return flight_controller.get_flight(flight_id)


@flight_blueprint.route('/available/<int:flight_id>', strict_slashes=False, methods=['GET'])
def get_available_seats(flight_id):
    return flight_controller.get_available_seats(flight_id)


@flight_blueprint.route('/reserved/<int:flight_id>/', strict_slashes=False, methods=['GET'])
def get_users_booked_on_flight(flight_id):
    return flight_controller.get_users_booked_on_flight(flight_id)


@flight_blueprint.route('/<string:from_location>/<string:to_location>/<string:departure_date>/', strict_slashes=False, methods=['GET'])
...
@flight_blueprint.route('/<string:from_location>/<string:to_location>/', strict_slashes=False, methods=['GET'])
...
@flight_blueprint.route('/', strict_slashes=False, methods=['POST'])
...
@flight_blueprint.route('/<int:flight_id>/', strict_slashes=False, methods=['PUT', 'PATCH'])
@Security.validator(['flightCode|required:string', 'fromLocation|required:string', 'status|required:string', 'toLocation|required:string', 'depatureTime|required:string', 'arrivalTime|required:string', 'noOfSeats|required:int', 'price|required:float'])
...
@flight_blueprint.route('/<int:flight_id>/', strict_slashes=False, methods=['DELETE'])
